...
function(t) {
    var e, i, a, n, o, s, r;
    KShop.$window = t(window),
    KShop.$body = t(document.body),
    KShop.status = "",
    KShop.isIE = navigator.userAgent.indexOf("Trident") >= 0,
    KShop.isEdge = navigator.userAgent.indexOf("Edge") >= 0,
    KShop.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
    KShop.call = function(t, e) {
        setTimeout(t, e)
    }
    ,
    KShop.parseOptions = function(t) {
        return "string" == typeof t ? JSON.parse(t.replace(/'/g, '"').replace(";", "")) : {}
    }
    ,
    KShop.parseTemplate = function(t, e) {
    ...
    ,
    KShop.byId = function(t) {
        return document.getElementById(t)
    }
    ,
    KShop.byTag = function(t, e) {
        return e ? e.getElementsByTagName(t) : document.getElementsByTagName(t)
    }
    ,
    KShop.byClass = function(t, e) {
        return e ? e.getElementsByClassName(t) : document.getElementsByClassName(t)
    }
    ,
    KShop.setCookie = function(t, e, i) {
        var a = new Date;
        a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3),
        document.cookie = t + "=" + e + ";expires=" + a.toUTCString() + ";path=/"
    }
    ,
    KShop.getCookie = function(t) {
    ...
    ,
    KShop.appear = function(e, i, a) {
        return a && Object.keys(a).length && t.extend(intersectionObserverOptions, a),
        new IntersectionObserver((function(e) {
            for (var a = 0; a < e.length; a++) {
                var n = e[a];
                n.intersectionRatio > 0 && ("string" == typeof i ? Function("return " + functionName)() : i.call(t(n.target)))
            }
        }
        ),{
    ...
    ,
    KShop.requestTimeout = function(t, e) {
    ...
    ,
    KShop.requestInterval = function(t, e, i) {
    ...
    ,
    KShop.deleteTimeout = function(t) {
        if (t) {
    ...
    ,
    KShop.setTab = function(e) {
        KShop.$body.on("click", ".tab .nav-link", (function(e) {
            var i = t(this);
            if (e.preventDefault(),
            !i.hasClass("active")) {
                var a = t(i.attr("href"));
    ...
    ,
    KShop.initCartAction = function(e) {
        KShop.$body.on("click", e, (function(e) {
    ...
    ,
    KShop.initScrollTopButton = function() {
        var e = KShop.byId("scroll-top");
    ...
    KShop.stickyToolboxOptions = {
        minWidth: 0,
        maxWidth: 767,
        top: !1,
        scrollMode: !0
    },
    KShop.stickyProductOptions = {
        minWidth: 0,
        maxWidth: 2e4,
        scrollMode: !0,
        top: !1,
    ...
    KShop.windowResized = function(e) {
        return e == KShop.resizeTimeStamp || (void 0 === window.innerHeight && (window.innerWidth = t(window).width() + KShop.getScrollbarWidth()),
        KShop.resizeChanged = KShop.canvasWidth != window.innerWidth,
        KShop.canvasWidth = window.innerWidth,
        KShop.resizeTimeStamp = e),
        KShop.resizeChanged
    }
    ,
    KShop.getScrollbarWidth = function() {
        if (void 0 === KShop.scrollbarSize) {
            var t = document.createElement("div");
            t.style.cssText = "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;",
            document.body.appendChild(t),
            KShop.scrollbarSize = t.offsetWidth - t.clientWidth,
            document.body.removeChild(t)
        }
        return KShop.scrollbarSize
    }
    ,
    KShop.stickyContent = function() {
        function e(t, e) {
            return this.init(t, e)
        }
        function i() {
            KShop.$window.trigger("sticky_refresh.wolmart", {
                index: 0,
                offsetTop: 0
            })
        }
        function a(t) {
            t && !KShop.windowResized(t.timeStamp) || (KShop.$window.trigger("sticky_refresh_size.wolmart"),
            i())
        }
        return e.prototype.init = function(e, i) {
            this.$el = e,
            this.options = t.extend(!0, {}, KShop.stickyDefaultOptions, i, KShop.parseOptions(e.attr("data-sticky-options"))),
            KShop.$window.on("sticky_refresh.wolmart", this.refresh.bind(this)).on("sticky_refresh_size.wolmart", this.refreshSize.bind(this))
        }
        ,
        ...
        e.prototype.refresh = function(t, e) {
            ...
            a.hasClass("product-sticky-content") && KShop.$body.addClass("addtocart-fixed")) : (a.removeClass("fixed").css("margin-top", "").css("margin-bottom", ""),
            this.onUnfixed && this.onUnfixed(),
            a.hasClass("product-sticky-content") && KShop.$body.removeClass("addtocart-fixed")),
            this.scrollPos = i) : (a.addClass("fixed"),
            this.onFixed && this.onFixed()),
            a.is(".fixed.fix-top") ? (e.offsetTop += a[0].offsetHeight,
            KShop.sticky_top_height = e.offsetTop) : a.is(".fixed.fix-bottom") && (e.offsetBottom += a[0].offsetHeight)) : (a.parent().css("height", ""),
        ...
        ,
        KShop.$window.on("kshop_complete", (function() {
            window.addEventListener("scroll", i, {
                passive: !0
            }),
            KShop.$window.on("resize", a),
            setTimeout((function() {
                a()
            }
            ), 300)
    ...
    KShop.parallax = function(e, i) {
        t.fn.themePluginParallax && KShop.$(e).each((function() {
            var e = t(this);
            e.themePluginParallax(t.extend(!0, KShop.parseOptions(e.attr("data-parallax-options")), i))
        }
        ))
    }
    ,
    KShop.skrollrParallax = function() {
        KShop.isMobile || "undefined" != typeof skrollr && KShop.$(".skrollable").length && skrollr.init({
            forceHeight: !1
        })
    }
    ,
    KShop.initFloatingParallax = function() {
        t.fn.parallax && KShop.$(".floating-item").each((function(e) {
            var i = t(this);
            ...
            i.parallax(KShop.parseOptions(i.data("options")))
        }
        ))
    }
    ,
    KShop.isotopeOptions = {
    ...
    KShop.isotopes = function(e, i) {
        if ("function" == typeof imagesLoaded && t.fn.isotope) {
            var a = this;
            KShop.$(e).each((function() {
                var e = t(this)
                  , n = t.extend(!0, {}, a.isotopeOptions, KShop.parseOptions(e.attr("data-grid-options")), i || {});
                KShop.lazyLoad(e),
                e.imagesLoaded((function() {
                    n.customInitHeight && e.height(e.height()),
                    n.customDelay && KShop.call((function() {
                        e.isotope(n)
                    }
    ...
    ,
    KShop.initNavFilter = function(e) {
        t.fn.isotope && KShop.$(e).on("click", (function(e) {
            var i = t(this)
            ...
            t(n || ".grid").isotope({
                ...
                KShop.$window.trigger("appear.check")
            }
            )),
    ...
    ,
    KShop.ratingTooltip = function(t) {
        for (var e = KShop.byClass("ratings-full", t || document.body), i = e.length, a = function() {
    ...
    ,
    KShop.setProgressBar = function(e) {
        KShop.$(e).each((function() {
            var e = t(this)
    ...
    ,
    KShop.alert = function(e) {
        KShop.$body.on("click", e + " .btn-close", (function(i) {
            i.preventDefault(),
    ...
    ,
    KShop.closeTopNotice = function(e) {
        KShop.$body.on("click", e, (function(e) {
            e.preventDefault(),
    ...
    ,
    KShop.accordion = function(e) {
        KShop.$body.on("click", e, (function(e) {
            var a = t(this)
              , n = a.closest(".card").find(a.attr("href"))
              , o = a.closest(".accordion");
            e.preventDefault(),
            0 === o.find(".collapsing").length && 0 === o.find(".expanding").length && (n.hasClass("expanded") ? o.hasClass("radio-type") || i(n) : n.hasClass("collapsed") && (o.find(".expanded").length > 0 ? KShop.isIE ? i(o.find(".expanded"), (function() {
                i(n)
            }
            )) : (i(o.find(".expanded")),
            i(n)) : i(n)))
    ...
    ,
    KShop.animationOptions = {
        name: "fadeIn",
        duration: "1.2s",
        delay: ".2s"
    },
    KShop.appearAnimate = function(e) {
        KShop.$(e).each((function() {
            var e = this;
            KShop.appear(e, (function() {
                if (e.classList.contains("appear-animate")) {
                    var i = t.extend({}, KShop.animationOptions, KShop.parseOptions(e.getAttribute("data-animation-options")));
                    setTimeout((function() {
    ...
    ,
    KShop.countDown = function(e) {
        t.fn.countdown && KShop.$(e).each((function() {
            var e = t(this)
              , i = e.data("until")
              , a = e.data("compact")
    ...
    ,
    KShop.priceSlider = function(e, i) {
        "object" == typeof noUiSlider && KShop.$(e).each((function() {
            var e = this;
    ...
    KShop.stickySidebar = function(e) {
        if (t.fn.themeSticky) {
            var i = 0;
            function a() {
                KShop.$(e).trigger("recalc.pin"),
            ...
            KShop.$(e).each((function() {
                var e = t(this);
                e.themeSticky(t.extend({}, KShop.stickySidebarOptions, {
                    padding: {
                        top: i
                    }
                }, KShop.parseOptions(e.attr("data-sticky-options"))))
            }
            )),
            setTimeout(a, 300),
            KShop.$window.on("click", ".tab .nav-link", (function() {
                setTimeout(a)
            }
            ))
        }
    ...
    KShop.zoomImageObjects = [],
    KShop.zoomImage = function(e) {
        t.fn.zoom && e && ("string" == typeof e ? t(e) : e).find("img").each((function() {
            var e = t(this);
            KShop.zoomImageOptions.target = e.parent(),
            KShop.zoomImageOptions.url = e.attr("data-zoom-image"),
            e.zoom(KShop.zoomImageOptions),
            KShop.zoomImageObjects.push(e)
        }
        ))
    }
    ,
    KShop.zoomImageOnResize = function() {
        KShop.zoomImageObjects.forEach((function(e) {
            e.each((function() {
    ...
    KShop.lazyLoad = function(t, e) {
        ...
        KShop.$(t).find(".lazy-img").each((function() {
            void 0 !== e && e ? i.call(this) : KShop.appear(this, i)
        }
        ))
    }
    ,
    KShop.initPopup = function(e, i) {
        KShop.$body.on("click", ".btn-iframe", (function(e) {
            e.preventDefault(),
            KShop.popup({
                items: {
        ...
        KShop.$body.on("click", ".sign-in", (function(e) {
            e.preventDefault(),
            KShop.popup({
                items: {
    ...
    ,
    KShop.initNotificationAlert = function() {
        KShop.$body.hasClass("has-notification") && setTimeout((function() {
            KShop.$body.addClass("show-notification")
        }
        ), 5e3)
    }
    ,
    KShop.countTo = function(e) {
        t.fn.countTo && KShop.$(e).each((function() {
            KShop.appear(this, (function() {
                var e = t(this);
                setTimeout((function() {
                    e.countTo({
                        onComplete: function() {
    ...
    ,
    {
        init: function() {
            ...
            KShop.byClass("page-wrapper")[0].appendChild(i),
            e = t(i),
            this.close = this.close.bind(this),
            r = r.bind(this)
        },
        open: function(n, l) {
            var c, d = this, p = t.extend(!0, {}, KShop.minipopupOption, n);
            c = t(KShop.parseTemplate(p.template, p)),
            d.space = p.space;
            ...
            u.length && u.on("load", (function() {
                ...
                KShop.$body.on("touchstart", (function() {
                    d.resume()
                }
                )),
                a.push(c),
    ...
    KShop.headerToggleSearch = function(t) {
        var e = KShop.$(t);
        KShop.$body.on("click", ".hs-toggle .search-toggle", (function(t) {
            t.preventDefault()
        }
        )),
        ...
        KShop.$body.on("click", (function(t) {
            e.removeClass("show")
        }
        )),
...
function(t) {
    var e = function(t) {
        t.preventDefault(),
        KShop.$body.addClass("mmenu-active")
    }
      , i = function(t) {
        t.preventDefault(),
        KShop.$body.removeClass("mmenu-active")
    }
      , a = {
        init: function() {
            this.initMenu(),
        ...
        initMenu: function() {
            ...
            KShop.$window.on("resize", (function() {
...
function(t) {
    ...
    var i = function(t) {
      ...
      , a = function(t) {
        ...
        for (e = 0; e < a; ++e)
            if (!i[e].classList.contains("active")) {
                var n, o = KShop.byClass("appear-animate", i[e]);
      ...
      , o = function() {
        ...
        t(this.wrapperEl).find(".swiper-slide-active .slide-animate").each((function() {
            var i = t(this)
              , a = t.extend(!0, {}, KShop.animationOptions, KShop.parseOptions(i.data("animation-options")))
              , n = a.duration
              , o = a.delay
              , s = a.name;
            setTimeout((function() {
                ...
                n = n || "0.75s";
                var a = KShop.requestTimeout((function() {
      ...
      , r = function(e) {
        ...
        a.find(".swiper-slide .slide-animate").each((function() {
            var e = t(this)
              , i = t.extend(!0, {}, KShop.animationOptions, KShop.parseOptions(e.data("animation-options")));
            ...
            i.prev != i.next) {
                ...
                a.hasClass("animation-slider")) {
                    for (var n = 0; n < i.timers.length; n++)
                        KShop.deleteTimeout(i.timers[n]);
                    i.timers = []
                }
                a.find(".swiper-slide-active .slide-animate").each((function() {
                    var e = t(this)
                      , a = t.extend(!0, {}, KShop.animationOptions, KShop.parseOptions(e.data("animation-options")))
                      , n = a.duration
                      , o = a.delay
                      , s = a.name;
                    ...
                    e.addClass(s),
                    n = n || "0.75s";
                    var r = KShop.requestTimeout((function() {
    ...
    e.prototype.init = function(c, d) {
        ...
        if (!c.data("slider")) {
            ...
            t.extend(!0, g, KShop.parseOptions(c.attr("data-swiper-options")), d),
            i.call(this),
    ...
    ,
    KShop.slider = function(i, a={}, n=!1) {
        KShop.$(i).each((function() {
            var i = t(this);
            n ? new e(i,a) : KShop.call((function() {
                new e(i,a)
            }
            ))
        }
    ...
    ,
    KShop.slider.pgToggle = function() {
...
function(t) {
    ...
    e.prototype.init = function(e) {
        ...
        KShop.$window.on("resize", i)),
        KShop.$window.on("resize", (function(t) {
            KShop.windowResized(t.timeStamp) && KShop.$body.removeClass(e + "-active")
        }
        )),
        ...
        a.$sidebar.find(".sidebar-overlay, .sidebar-close").on("click", (function(t) {
            KShop.$body.removeClass(e + "-active"),
            t.preventDefault()
        }
        ))),
        !1
    ...
    e.prototype.toggle = function() {
        ...
        window.innerWidth >= i && e.$sidebar.hasClass("sidebar-fixed")) {
            ...
            KShop.$body.toggleClass(e.name + "-active").removeClass("closed");
        setTimeout((function() {
            t(window).trigger("appear.check")
        }
        ), 400)
...
function(t) {
    var e = {
        init: function() {
            var e;
            KShop.call(KShop.ratingTooltip, 500),
            KShop.call(KShop.setProgressBar(".progress-bar"), 500),
            this.initVariation(),
            this.initProductsScrollLoad(".scroll-load"),
            KShop.$body.on("mousedown", ".select-menu", (function(e) {
                var i = t(e.currentTarget)
                  , a = t(e.target)
                  , n = i.hasClass("opened");
            ...
            KShop.$body.on("click", ".select-menu a", (function(t) {
                t.preventDefault()
            }
            )),
            KShop.$body.on("click", ".selected-item i", (function(e) {
            ...
            KShop.$body.on("mousedown", (function(e) {
                t(".select-menu").removeClass("opened")
            }
            )),
            KShop.$body.on("click", ".filter-items a", (function(e) {
                var i = t(this).closest(".filter-items");
                i.hasClass("search-ul") || i.parent().hasClass("select-menu") || (t(this).parent().toggleClass("active"),
                e.preventDefault())
            }
            )),
            KShop.$body.on("click", ".product:not(.product-select) .btn-cart, .product-popup .btn-cart, .home .product-single .btn-cart", (function(e) {
                e.preventDefault();
                
                var i = t(this)
                  , a = i.closest(".product, .product-popup");
                  
                console.log('vào func main');
                if(i.hasClass('notAdd')) {
                    i.removeClass('notAdd')
                    return
                }

                i.hasClass("disabled") ? '' : (i.toggleClass("added").addClass("load-more-overlay loading"),
                setTimeout((function() {
                    i.removeClass("load-more-overlay loading"),
                    KShop.Minipopup.open({
                        productClass: " product-cart",
                        name: a.find(".product-name, .product-title").text(),
                        nameLink: a.find(".product-name > a, .product-title > a").attr("href"),
                        imageSrc: a.find(".product-media img, .product-image:first-child img").attr("src"),
                        imageLink: a.find(".product-name > a").attr("href"),
                        message: "<p>đã thêm vào giỏ hàng:</p>",
                        actionTemplate: '<a href="/cart" class="btn btn-rounded btn-sm">Giỏ hàng</a><a href="/checkout" class="btn btn-dark btn-rounded btn-sm">Thanh toán</a>'
                    })
                }
                ), 500))
            }
            )),
            KShop.$body.on("click", ".product:not(.product-single) .btn-wishlist", (function(e) {
                e.preventDefault();
                var i = t(this);
            ...
            (e = t(".product-popup")).length && KShop.$body.on("click", ".btn-quickview", (function(i) {
                i.preventDefault(),
                KShop.popup({
                    items: {
                        src: e[0].outerHTML
                    ...
                    callbacks: {
                        open: function() {
                            KShop.productSingle(t(".mfp-product .product-single"))
                        },
                        close: function() {
            ...
            function() {
                ...
                a.length || document.body.classList.contains("docs") || (t(".page-wrapper").append('<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Xóa tất cả</a>                        <a href="compare.html" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'),
                a = t(".page-wrapper > .compare-popup")),
                KShop.$body.on("click", ".product .btn-compare", (function(o) {
                    var s = t(this);
                ...
                KShop.$body.on("click", ".compare-popup-overlay", (function() {
                    a.removeClass("show")
                }
                ))
            }(),
            KShop.priceSlider(".filter-price-slider")
        },
        ...
        initProductsScrollLoad: function(e) {
            var i, a = KShop.$(e), n = t(e).data("url");
                ...
                window.pageYOffset > i + a.outerHeight() - window.innerHeight - 150 && "loading" != a.data("load-state") && t.ajax({
                    ...
                    success: function(e) {
                        ...
                        setTimeout((function() {
                            ...
                            KShop.countDown(i.find(".product-countdown"))
                        }
                        ), 500);
...
function(t) {
    ...
    e.prototype.init = function(t) {
        ...
        KShop.$body.on("mouseup", i.stop).on("touchend", i.stop).on("touchcancel", i.stop)
    }
    ,
    e.prototype.startIncrease = function(t) {
        ...
        e.increaseTimer = KShop.requestTimeout((function() {
            e.speed = 1,
            e.increaseTimer = KShop.requestInterval((function() {
    ...
    e.prototype.startDecrease = function(t) {
        ...
        e.decreaseTimer = KShop.requestTimeout((function() {
            e.speed = 1,
            e.decreaseTimer = KShop.requestInterval((function() {
    ...
    e.prototype.stop = function(t) {
        KShop.deleteTimeout(this.increaseTimer),
        KShop.deleteTimeout(this.decreaseTimer)
    }
    ,
    KShop.initQtyInput = function(i) {
        KShop.$(i).each((function() {
            var i = t(this);
...
function(t) {
    ...
    var i = function() {
      ...
      , n = function(e) {
        e.preventDefault(),
        KShop.scrollTo(t('.product-tabs > .nav a[href="' + this.getAttribute("href") + '"]').trigger("click"))
    };
    e.prototype.init = function(e) {
        var o = this
        ...
        "complete" === KShop.status && (KShop.slider(s, {
            thumbs: {
                swiper: o.$thumbsWrap.data("slider")
            }
        }),
        KShop.initQtyInput(e.find(".quantity"))),
        s.length && window.addEventListener("resize", (function() {
            KShop.requestTimeout((function() {
        ...
        o.$wrapper.find(".product-single-swiper").on("initialized.slider", (function(e) {
            t(e.target).find(".product-image").zoom(KShop.zoomImageOptions)
        }
        )),
        ...
        function(e) {
            ...
            e.$items.children("a").on("click", (function(i) {
                var textSpan = this.querySelector('span').innerText
                if(this.classList.contains('active')) 
                    textSpan = ''
                if(this.parentNode.parentNode) {
                    this.parentNode.parentNode.querySelector('label > span').innerHTML = textSpan
                }
    ...
    e.prototype.swatchImage = function() {
        var t = _$$(".size.active img")[_$$(".size.active").length-1]?.src
          , e = this.$wrapper.find(".swiper-slide:first-child .product-image img")
          , i = this.$wrapper.find(".swiper-slide:first-child .product-thumb img");
        if(!t?.includes(selectedProduct)) {
            e.attr("src", t),
            i.attr("src", t)
        } 
    }
    ,
    KShop.productSingle = function(i) {
        return KShop.$(i).each((function() {
            var i = t(this);
...
function(t) {
    ...
    KShop.initProductSinglePage = function() {
        t(".product-gallery").each((function() {
            var e = t(this)
              , i = e.find(".product-image");
            i.length && 0 == e.find(".swiper-container").length && i.zoom(KShop.zoomImageOptions)
        }
        )),
        function(e) {
            var i = t(".product-sticky-content")
        ...
        document.body.classList.contains("home") || KShop.$body.on("click", ".product-image-full", e).on("click", ".review-image img", e).on("click", ".product-video-viewer", i).on("click", ".product-degree-viewer", (function(e) {
            e.preventDefault(e),
...
function(t) {
    KShop.initCodePopup = function() {
        ...
        KShop.$body.on("click", ".box-btn.showcode", (function() {
            var e = t(this);
        ...
        KShop.$body.on("click", ".show-code", (function(e) {
            e.stopPropagation();
            var i = t(this).parent();
            if (i.hasClass("show-code-added")) {
                ...
                KShop.$body.on("click", ".code-copy a", (function(e) {
                    e.preventDefault(),
        ...
        KShop.$body.on("mouseenter mouseleave", ".show-code-action", (function(t) {
            t.stopPropagation()
        }
        ))
    }
...
function(t) {
    ...
    e.prototype.init = function(a, n) {
        var o = this;
        o.element = a,
        o.settings = t.extend({}, !0, e.defaultOptions, KShop.parseOptions(a.attr("data-calendar-options")), n),
        o.today = new Date,
        i = i.bind(this);
    ...
    ,
    KShop.initLoginVendor = function(e) {
        var i = t(e)
...
jQuery,
KShop.initLayout = function() {
    KShop.isotopes(".grid:not(.grid-float)"),
    KShop.stickySidebar(".sticky-sidebar")
}
,
KShop.init = function() {
    KShop.appearAnimate(".appear-animate"),
    KShop.setTab(".nav-tabs"),
    KShop.stickyContent(".sticky-header", {
        scrollMode: !1
    }),
    KShop.stickyContent(".sticky-footer", {
        minWidth: 0,
        maxWidth: 767,
        top: 150,
        hide: !0,
    ...
    KShop.stickyContent(".sticky-toolbox", KShop.stickyToolboxOptions),
    KShop.stickyContent(".product-sticky-content", KShop.stickyProductOptions),
    KShop.parallax(".parallax"),
    KShop.skrollrParallax(),
    KShop.initFloatingParallax(),
    KShop.menu.init(),
    KShop.initScrollTopButton(),
    KShop.shop.init(),
    KShop.alert(".alert"),
    KShop.closeTopNotice(".banner-close"),
    KShop.accordion(".card-header > a"),
    KShop.sidebar("sidebar"),
    KShop.sidebar("right-sidebar"),
    KShop.productSingle(".product-single"),
    KShop.initProductSinglePage(),
    KShop.initQtyInput(".quantity"),
    KShop.initNavFilter(".nav-filters .nav-filter"),
    KShop.calendar(".calendar-container"),
    KShop.countDown(".product-countdown, .countdown"),
    KShop.initPopup(),
    KShop.initNotificationAlert(),
    KShop.countTo(".count-to"),
    KShop.initCartAction(".cart-offcanvas .cart-toggle"),
    KShop.Minipopup.init(),
    KShop.headerToggleSearch(".hs-toggle"),
    KShop.initVendor(".store"),
    KShop.slideContent(".login-toggle"),
    KShop.slideContent(".coupon-toggle"),
    KShop.slideContent(".checkbox-toggle"),
    KShop.initLoginVendor(".user-checkbox"),
    KShop.initCodePopup(),
    KShop.slider(".swiper-container"),
    KShop.call(KShop.slider.pgToggle),
    KShop.$window.on("resize", (function() {
        KShop.call(KShop.slider.pgToggle)
    }
    ))
...
window.onload = function() {
    KShop.canvasWidth = window.innerWidth,
    KShop.resizeTimeStamp = 0,
    KShop.resizeChanged = !1,
    KShop.status = "loaded",
    document.body.classList.add("loaded"),
    KShop.call(KShop.initLayout),
    KShop.call(KShop.init),
    KShop.status = "complete",
    KShop.$window.trigger("kshop_complete")
}
;
