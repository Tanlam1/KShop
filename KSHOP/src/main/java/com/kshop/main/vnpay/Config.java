...
public class Config {
    ...
    public static String vnp_Returnurl = Constant.DIR.WEB_ROOT + "/checkout";
    public static String vnp_TmnCode = "AMXF147F";
    public static String vnp_HashSecret = "QSWFVPWEIZICSVAXFBUOKPCVYCRKYKVI";
