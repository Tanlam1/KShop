...
@Controller
@RequestMapping("/admin-panel/review-products")
public class ProductReviewAdminController extends com.kshop.main.controller.Controller {
	...
	public String layout(Model model) throws IOException { 
	    ...
	    dataLayoutMaster.setView("admin/product-review/product-review");
	    dataLayoutMaster.setJsList(Arrays.asList("/admin/assets/js/product-reviews/script.js"));
