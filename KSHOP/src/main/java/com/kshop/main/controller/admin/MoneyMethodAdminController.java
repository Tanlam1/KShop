...
@Controller
@RequestMapping("/admin-panel/money-receive")
public class MoneyMethodAdminController extends com.kshop.main.controller.Controller {
	...
	public String layout(Model model) throws IOException {      
	    ...
	    dataLayoutMaster.setView("admin/money-receive/method");
	    dataLayoutMaster.setJsList(Arrays.asList("/admin/assets/js/money-receive/method.js"));
