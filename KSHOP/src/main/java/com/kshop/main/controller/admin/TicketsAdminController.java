...
@Controller
@RequestMapping("/admin-panel/support-ticket")
public class TicketsAdminController extends com.kshop.main.controller.Controller {
	...
	public String layout(Model model) throws IOException { 
	    ...
	    dataLayoutMaster.setView("admin/support-ticket/support-ticket");
