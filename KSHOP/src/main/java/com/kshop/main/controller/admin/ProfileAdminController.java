...
public class ProfileAdminController extends com.kshop.main.controller.Controller {
	...
	public String layout(Model model) throws IOException { 
	    ...
	    dataLayoutMaster.setView("admin/profile/profile");
	    dataLayoutMaster.setJsList(Arrays.asList("/admin/assets/profile/profile.js", "/admin/assets/js/ckeditor.js", "/admin/assets/js/ckeditor-custom.js"));
